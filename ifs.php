      ...
      <form action="php/post_found.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="upload-box">
            ...
            <p>Click to upload a photo of the found item</p>
        ...
        <div class="form-group">
          ...
          <select name="held_at">
            <option value="" disabled selected>Where is the item now?</option>
            <option>With me (contact to collect)</option>
            <option>Handed to Security Desk</option>
            <option>Left at Library Counter</option>
            <option>Left at Department Office</option>
            <option>Other</option>
          </select>
